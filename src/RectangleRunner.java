...
public class RectangleRunner {
    public static void main(String[] args) {
        ...
        double volume = rect1.calculateBoxVolume(rect1Height);
        System.out.println("Rectangle 1's area: " + area + " Box volume: " + volume);

        Rectangle rect2 = new Rectangle(rect2Length,rect2Width);
        int area2 = rect2.calculateArea();
        double volume2 = rect2.calculateBoxVolume(rect1Height);
        System.out.println("Rectangle 1's area: " + area2 + " Box volume: " + volume2);
    }
}
